...
| 프로젝트명 | 설명 | 기간 |
| --- | --- | --- |
| **onsurvey - 앱인토스** | 설문 제작부터 신뢰할 수 있는 응답까지 수집할 수 있는 서비스 | 2025/09 ~ |
| **LG 기업 연계 프로젝트** | LifeZip 사용성 개선 | 2025/08 ~ 2025/09 |
| **Store Group - 앱인토스** | 영업 사원을 위한 방문할 매장 그루핑 서비스 | 2025/08 ~ |
| **SMUS** | 캠퍼스 라이프에 도움을 주는 MCP 기반 에이전트형 챗봇 | 2025/06 ~ 2025/11 |
...
| 활동 | 활동 기간 | 활동 내용 |
| --- | --- | --- |
| 큐시즘 31기, 32기 | 2025/02 ~ 2025/06 | 기업 프로젝트, 사이드 프로젝트 진행 및 백엔드 스터디 |
